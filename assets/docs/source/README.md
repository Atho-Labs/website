...
- **Fees/Burn (current):** fee floor `225 atoms/vB` (`2.25e-7 ATHO/vB`), minimum tx fee `100,000 atoms` (`0.000100000 ATHO`), dust `250 atoms`. Post-tail target split is `100% burn / 0% miner fee share`, clipped by a hard supply floor at `21,000,000 ATHO`.
